...
let db_spec = Irmin.Backend.Conf.Spec.v "indexeddb_db_name"

let db_name_key =
  Irmin.Backend.Conf.(key ~spec:db_spec "indexeddb_db_name" Irmin.Type.string "Irmin")
...
let v name = Irmin.Backend.Conf.singleton db_spec db_name_key name
